        ...
        <section className="bg-white py-16 ">
            <div className="container mx-auto px-4">
                ...
                <div className="relative">
                    ...
                    <button className=' bg-white flex items-center justify-center rounded-full shadow-lg h-10 w-10 absolute
                    ...
                    <button className=' bg-white flex items-center justify-center rounded-full shadow-lg h-10 w-10 absolute
                    -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10'
                    onClick={scrollNext} 
                    >
                        <ChevronRight
                        className='w-6 h-6 text-gray-600'/>
